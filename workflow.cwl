...
doc: |
  This workflow will run and evaluate a Docker submission to the MOD - Preterm Birth Prediction Microbiome Challenge (syn26133771). Metrics returned are ROC, PR, Accuracy, Sensitivity, Specificity.
